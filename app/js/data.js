...
const lineup = [
  {
    id: "0bf7b4e6-4022-4025-a1f5-e4911f3e0213",
    stage: "Main Stage",
    artist: {
      name: "The 1975",
      description:
      ...
      video:
        "videos/yt5s.io-The 1975 - Oh Caroline (Official Live Performance) _ Vevo-(480p).mp4",
    },
    from: 1688053500000,
    to: 1688057100000,
  },
  {
    id: "b1c6a281-7acd-4e07-ba69-d58dbc023d06",
    stage: "The Barn",
    artist: {
      name: "Ben Howard",
      description:
      ...
      video: "videos/yt5s.io-Ben Howard - What A Day-(480p).mp4",
    },
    from: 1688147400000,
    to: 1688151000000,
  },
  {
    id: "ac3c227c-1ca4-44b2-9950-f240e4466d0b",
    stage: "The Barn",
    artist: {
      name: "Fred Again..",
      description:
      ...
      video:
        "videos/yt5s.io-Fred again.. - Bleu (better with time) [Official Video]-(480p).mp4",
    },
    from: 1688242800000,
    to: 1688246400000,
  },
  {
    id: "79b97b1d-8f19-4531-ae20-9a7e0a98aa0f",
    stage: "Main Stage",
    artist: {
      ...
      video:
        "videos/yt5s.io-Machine Gun Kelly - Taurus (Feat. Naomi Wild) [From the Motion Picture Taurus]-(480p).mp4",
    },
    from: 1688231100000,
    to: 1688235600000,
  },
  {
    id: "359fc226-a201-411d-a8f0-84c1cde3a67b",
    stage: "Klub C",
    artist: {
      name: "Adekunle Gold",
      description:
      ...
      socials: {
        ...
        spotify:
          "https://open.spotify.com/artist/2IK173RXLiCSQ8fhDlAb3?si=j4FuEJTHQsONl2yVJYueBw",
        youtube: "https://www.youtube.com/channel/UC3RP_IbJrcP8cIwOC7wRj5g",
      },
      image: "images/adekunle-gold.jpg",
      video:
        "videos/yt5s.io-Adekunle Gold - 5 Star (Official Music Video)-(480p).mp4",
    },
    from: 1688231100000,
    to: 1688235600000,
  },
  {
    id: "4c9b1012-bdb5-42b9-bb80-1a16ed5a80a8",
    stage: "Main Stage",
    artist: {
      name: "Zwangere Guy",
      description:
      ...
      video: "videos/yt5s.io-Zwangere Guy - Gorik Pt. 1-(480p).mp4",
    },
    from: 1688041200000,
    to: 1688044800000,
  },
  {
    id: "ed5da33f-420e-416b-84ef-49d2ab462432",
    stage: "The Barn",
    artist: {
      name: "Rosalía",
      description:
      ...
      socials: {
        ...
        spotify:
          "https://open.spotify.com/artist/7ltDVBr6mKbRvohxheJ9h?autoplay=true&v=A",
        youtube: "https://www.youtube.com/channel/UCQt9awGIFZeldFsATZNeJag",
      },
      image: "images/rosalia.jpg",
      video: "videos/yt5s.io-ROSALÍA - DESPECHÁ (Official Video)-(480p).mp4",
    },
    from: 1688327700000,
    to: 1688332200000,
  },
  {
    id: "b26bfabd-1b18-4802-a41d-29a16dfdd58c",
    stage: "Main Stage",
    artist: {
      ...
      video:
        "videos/yt5s.io-Black Box Revelation - Wrecking Bed Posts (Lyric Video)-(480p).mp4",
    },
    from: 1688132400000,
    to: 1688136000000,
  },
  {
    id: "38c59753-4f44-4ca3-8fa0-a862793275a5",
    stage: "The Barn",
    artist: {
      name: "Amenra",
      description:
      ...
      video:
        "videos/yt5s.io-AMENRA - De Evenmens (Official Music Video)-(480p).mp4",
    },
    from: 1688300700000,
    to: 1688303700000,
  },
  {
    id: "e1f2925b-bf4f-4b2f-9f58-2afba0b39767",
    stage: "Klub C",
    artist: {
      name: "Pip Millet",
      description:
      ...
      socials: {
        ...
        spotify:
          "https://open.spotify.com/artist/1QfEfvB62EEl4upf2ANKk?si=Vao-TtG8TxylRUs6NpxphA",
        youtube: "https://www.youtube.com/channel/UCvge6efpKy1ef9CQB4c7hcg",
      },
      image: "images/pip-millet.jpg",
      video: "videos/yt5s.io-Pip Millett - My Way (Official Video)-(480p).mp4",
    },
    from: 1688298600000,
    to: 1688300700000,
  },
  {
    id: "d6bcfcc9-54df-47bd-96c9-38bd3a0edab3",
    stage: "Main Stage",
    artist: {
      name: "Stormzy",
      description:
      ...
      video:
        "yt5s.io-STORMZY - THIS IS WHAT I MEAN (starring. AMAARAE, BLACK SHERIF, JACOB COLLIER, MS BANKS & STORRY)-(480p).mp4",
    },
    from: 1688067000000,
    to: 1688070600000,
  },
...
const timeLeft = 1720087200000;

const filterInf = ["Main Stage", "The Barn", "Klub C"];

const socialSVG = {
  instagram: "images/instagram-logo.svg",
  twitter: "images/x-logo.svg",
